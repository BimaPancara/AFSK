...
class pkt_fsk_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='text.txt'):
        ...
        self.soapy_hackrf_sink_0.set_frequency(0, 2.72922e9)
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, (2*math.pi*vco_max), 0.9)
        ...
        self.connect((self.blocks_repeat_1, 0), (self.blocks_probe_rate_0, 0))
        self.connect((self.blocks_repeat_1, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.blocks_repeat_1, 0), (self.soapy_hackrf_sink_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_repack_bits_bb_1_0, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_repeat_1, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "--InFile", dest="InFile", type=str, default='text.txt',
